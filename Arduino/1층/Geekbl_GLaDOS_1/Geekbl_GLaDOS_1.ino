...
/*-----------------------------------------------------------------------------------*/
void ani_right_to_left(){
  unsigned long time = millis();

  if(time -  previoustime1 >= 60){
    previoustime1 = time;
    if(dmx_4_angle != 2000 && dmx_4_angle <= 6000){
      dmx_4_angle -= 10;
      if(dmx_4_angle == 2000){
        switch_angle = 1;
      }
...
/*-----------------------------------------------------------------------------------*/
void ani_left_to_right(){
  unsigned long time = millis();

  if(time -  previoustime2 >= 60){
    previoustime1 = time;
    if(dmx_4_angle != 6000 && dmx_4_angle >= 2000){
      dmx_4_angle += 10;
      if(dmx_4_angle == 6000){
        switch_angle = 0;
      }
      dxl.setGoalPosition(DXL_ID4, dmx_1_angle);
    }
  }
}
/*-----------------------------------------------------------------------------------*/
